...
const Footer = () => {
    return (
        <footer className="bg-gray-800 text-white py-8 w-[100%] flex flex-col  items-center justify-center">
            <div className="container mx-auto flex flex-col justify-center md:flex-row md:justify-between items-center">
                <div className="mb-4 md:mb-0 flex flex-col md:justify-left md:items-start items-center">
                    <h4 className="font-semibold text-lg">Contact Us</h4>
                    <p className="text-md">Phone: +91 9876543210</p>
                    <p className="text-md">Email: sriskathiCoders@gmail.com</p>
                </div>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    {/* Facebook */}
                    <a href="#" className="hover:text-blue-500 transition-all delay-75  hover:-translate-y-1">
                    ...
                    {/* Instagram */}
                    <a href="#" className="hover:text-pink-500 transition-all delay-75  hover:-translate-y-1">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* LinkedIn */}
                    <a href="#" className="hover:text-blue-700 transition-all delay-75  hover:-translate-y-1">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* YouTube */}
                    <a href="#" className="hover:text-red-600 transition-all delay-75  hover:-translate-y-1">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
